...
public class Vision_and_History_SEO {
	...
	public static void Vision_and_History_SEO_test() throws IOException, InterruptedException
	{
		...
		PageFactory.initElements(driver, Vision_and_History_SEO.class); 
		syz_wait_con.waitforpagetobeload(contents2);
		Thread.sleep(500);
		DropDrown.getValue("html/body/table[14]/tbody/tr/td[4]/a", " //td/a[text()='Vision and History SEO']");
		Thread.sleep(500);
		System.out.println(seo.getText());
		if(seo.getText().equalsIgnoreCase("Edit Vision and History SEO"))
		{
			Reporter.log("Vision and History SEO= land on correct page..");
		}
		else
		{
			Reporter.log("Vision and History SEO= OOP something went wrong...");
		}
	}
